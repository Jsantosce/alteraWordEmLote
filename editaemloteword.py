...
class Aplicativo:
    def __init__(self, master):
        ...
        #  botão para selecionar a pasta de documentos
        ...
        # botão para criar os documentos
    ...
    def selecionar_pasta(self):
        # janela de seleção de diretório e obtenha o caminho selecionado
    ...
    def criar_documentos(self):
        ...
        for arquivo in os.listdir(self.diretorio):
            if arquivo.endswith(".docx") or arquivo.endswith(".doc"):
                ...
                # Substitue as informações antigas pelas novas em cada parágrafo do documento
                ...
                # Salva o documento atualizado com o mesmo nome do original
